...
public class ChangePhoneActivity extends BaseActivity implements ChangePhoneContract.View {
    ...
    protected void obtainData() {
        ...
        tvPhone.setText(WonderfulToastUtils.getString(this,R.string.handsetTailNumber)+phone.substring(7,11)+WonderfulToastUtils.getString(this,R.string.receiveMessageCode));
    }
