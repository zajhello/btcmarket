...
//                    WonderfulToastUtils.showToast(WonderfulToastUtils.getString(R.string.parse_error));
    ...
    @Override
    public void getSwitchPattern(String contractCoinId, String targetPattern,String token) {
    ...
    @Override
    public void getModifyLeverage(String contractCoinId, String leverage, String direction,String token) {
