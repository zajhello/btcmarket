...
public class DataRepository implements DataSource {
    ...
    @Override
    public void allHomeCurrencyall(DataCallback dataCallback) {
        if (isLocal) mLocalDataSource.allHomeCurrencyall(dataCallback);
        else mRemoteDataSource.allHomeCurrencyall(dataCallback);
    }
